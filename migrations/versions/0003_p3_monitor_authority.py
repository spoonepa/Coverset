...
def upgrade() -> None:
    ...
    if "locked_days" not in tables:
        op.create_table(
            ...
            sa.UniqueConstraint("board_id", "shoot_date", name="uq_locked_days_board_date"),
        )
        op.create_index("ix_locked_days_production_id", "locked_days", ["production_id"])
    ...
    if "monitor_findings" not in tables:
        op.create_table(
            ...
            sa.Column("production_id", sa.String(48), sa.ForeignKey("productions.id"), nullable=False),
            sa.Column("board_id", sa.String(48), sa.ForeignKey("boards.id"), nullable=False),
            sa.Column("evidence_id", sa.String(48), sa.ForeignKey("grounding_evidence.id"), nullable=True),
        ...
        op.create_index("ix_monitor_findings_board_id", "monitor_findings", ["board_id"])
    ...
    if "replan_requests" not in tables:
        op.create_table(
            ...
            sa.Column("id", sa.String(48), primary_key=True),
            sa.Column("production_id", sa.String(48), sa.ForeignKey("productions.id"), nullable=False),
            sa.Column("finding_id", sa.String(48), sa.ForeignKey("monitor_findings.id"), nullable=False),
            sa.Column("current_board_id", sa.String(48), sa.ForeignKey("boards.id"), nullable=False),
        ...
        op.create_index("ix_replan_requests_production_id", "replan_requests", ["production_id"])
        op.create_index("ix_replan_requests_finding_id", "replan_requests", ["finding_id"])
        op.create_index("ix_replan_requests_current_board_id", "replan_requests", ["current_board_id"])
    ...
    if "board_selections" not in tables:
        op.create_table(
            ...
            sa.Column("selected_board_id", sa.String(48), sa.ForeignKey("boards.id"), nullable=False),
        ...
        op.create_index("ix_board_selections_production_id", "board_selections", ["production_id"])
        op.create_index("ix_board_selections_selected_board_id", "board_selections", ["selected_board_id"])
    ...
    if "cost_approvals" not in tables:
        ...
        op.create_index("ix_cost_approvals_production_id", "cost_approvals", ["production_id"])
...
def downgrade() -> None:
    ...
    for table, indexes in (
        ("cost_approvals", ("ix_cost_approvals_board_id", "ix_cost_approvals_production_id")),
        (
            "board_selections",
            ("ix_board_selections_selected_board_id", "ix_board_selections_production_id"),
        ),
        (
            "replan_requests",
            (
        ...
        ("monitor_findings", ("ix_monitor_findings_board_id", "ix_monitor_findings_production_id")),
