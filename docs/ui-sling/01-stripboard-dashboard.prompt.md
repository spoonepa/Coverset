...
Create the main desktop stripboard dashboard screen. It must show left nav, top context bar, board version, day 8 of 20, locked days 1-8, vertical stripboard grouped by shoot day, right inspector, solver validation status, and buttons Load Demo Production, Generate Board, Validate Board, View Sources, Compare Options.
