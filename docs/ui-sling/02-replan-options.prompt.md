...
Create the desktop replan alert and option comparison screen. It must show a weather change from 20% to 85% rain for Day 14, locked-day preservation, 2 validated viable board options, 1 clearly separated Exception Scenario that is not an active schedule, cost deltas, and Select Option / View Diff / Request Cost Approval buttons.
