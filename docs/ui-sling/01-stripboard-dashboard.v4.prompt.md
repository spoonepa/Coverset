...
Create a dark dense stripboard dashboard. Must include left rail, top context bar, production The Glasshouse, schedule v4 active, Day 8 of 20, role First AD, solver/validator status, locked days count, company moves, holding cost, weather risks. Main area: vertical stripboard grouped by shoot day with LOCKED/PLANNED pills, scene IDs, locations, day/night, cast chips, call/wrap, Cast OK, Permit OK, Daylight OK, Turnaround OK. Right inspector: selected Day 14 and independent validation summary. Buttons: Load Demo Production, Generate Board, Validate Board, Compare Options, View Sources.