...
Create a dark dense replan alert and option comparison screen. Must say Material Weather Fact Changed: rain forecast increased 20% -> 85% for Day 14 exterior scenes. Show Days 1-8 locked/immutable. Show Option A and Option B as VALIDATED viable boards with cost/risk deltas. Show Exception Scenario C visually separate as NOT AN ACTIVE SCHEDULE with Request Weather Waiver / Record Production Waiver, not UPM cost approval. First AD can select validated options.